...
if ($search !== '') {
    $where .= " AND (s.return_item LIKE ? OR s.exchange_item LIKE ? OR s.username LIKE ? OR s.id LIKE ?)";
    $lk = "%$search%";
                    ...
                    <div class="flex items-center gap-2">
                        <div class="grid grid-cols-2 gap-2 w-full sm:w-64">
                            ...
                            <label class="relative cursor-pointer group">
                                ...
                                <div class="py-1.5 px-3 flex items-center justify-center gap-2 rounded-lg bg-slate-900 border border-white/5 peer-checked:border-orange-500/50 peer-checked:bg-orange-500/10 transition-all">
                                    <i class="fas fa-clock text-[9px] text-gray-500 peer-checked:text-orange-400"></i>
                                    <span class="text-[9px] font-bold text-gray-500 peer-checked:text-orange-400 uppercase tracking-tighter">Current</span>
                                </div>
                            </label>
                            ...
                            <label class="relative cursor-pointer group" onclick="document.getElementById('page_custom_date').showPicker()">
                                ...
                                <div id="backdate-btn-content" class="py-1.5 px-3 flex items-center justify-center gap-2 rounded-lg bg-slate-900 border border-white/5 peer-checked:border-orange-500/50 peer-checked:bg-orange-500/10 transition-all overflow-hidden relative">
                                     <i class="fas fa-history text-[9px] text-gray-500 peer-checked:text-orange-400"></i>
                                     <span id="backdate-text" class="text-[9px] font-bold text-gray-500 peer-checked:text-orange-400 uppercase tracking-tighter">Backdate</span>
    ...
    document.addEventListener('click', function(e) {
        ...
        if (trigger) {
            ...
            if (hiddenSelect) {
                ...
                // Trigger change event for table refresh
