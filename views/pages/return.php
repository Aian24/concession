                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div class="space-y-1">
                                <label class="text-[9px] font-bold text-gray-500 uppercase ml-1">Qty</label>
                                <input type="number" name="exchange_quantity" id="edit-ex-qty" min="0" max="999" maxlength="3" oninput="this.value = this.value.replace(/[^0-9]/g, '').substring(0, 3);" onkeydown="if(['e','E','+','-','.'].includes(event.key)) event.preventDefault();" class="w-full bg-slate-900 border border-white/10 rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-blue-500/50 transition-all font-medium" placeholder="0">
                            </div>
                        </div>
                        <div class="space-y-1">
                            <label class="text-[9px] font-bold text-gray-500 uppercase ml-1">Amount (₱)</label>
                ...
                <div class="p-4 space-y-3">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="relative mt-2">
                            ...
                            <input type="number" min="0" max="999" maxlength="3" class="entry-qty bg-slate-900 border border-white/10 rounded-lg px-3 py-2 w-full text-xs text-white focus:outline-none focus:border-orange-500/50" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').substring(0, 3); updateStats();" onkeydown="if(['e','E','+','-','.'].includes(event.key)) event.preventDefault();">
                        </div>
                    </div>
                    <div class="relative mt-2">
                    ...
                    <div id="exchange-inputs-${rowId}" class="space-y-3 opacity-50 pointer-events-none transition-opacity duration-300">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div class="relative mt-2">
                                ...
                                <input type="number" min="0" max="999" maxlength="3" class="entry-ex-qty bg-slate-900 border border-white/10 rounded-lg px-3 py-2 w-full text-xs text-white focus:outline-none focus:border-blue-500/50" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').substring(0, 3); updateStats();" onkeydown="if(['e','E','+','-','.'].includes(event.key)) event.preventDefault();">
                            </div>
                            <div class="relative mt-2">
