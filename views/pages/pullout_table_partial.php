        ...
        <div class="grid grid-cols-2 <?= $is_admin ? 'lg:grid-cols-6' : 'lg:grid-cols-5' ?> gap-3 bg-white/5 p-3 rounded-xl border border-white/5">
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="search" value="<?= htmlspecialchars($search) ?>" placeholder="ITR # / OS # or User..." 
            ...
            <div class="space-y-1">
                ...
                <div class="relative w-full">
                    <label class="text-[9px] font-bold text-gray-500 uppercase ml-1">Quick Year <span class="text-amber-400/60" id="table-yr-multi-hint"><?= $yr_hint ?></span></label>
            ...
            <div class="space-y-1">
                ...
                ?>
                <div class="relative w-full">
                    <label class="text-[9px] font-bold text-gray-500 uppercase ml-1">Quick Month <span class="text-amber-400/60" id="table-mo-multi-hint"><?= $mo_hint ?></span></label>
                ...
                <div class="shrink-0 flex items-center bg-slate-900/80 border border-white/10 rounded-lg shadow-inner h-8 relative z-20 overflow-hidden w-full">
                    ...
                    <div id="table-months-container" class="flex items-center gap-1 overflow-x-auto hide-scrollbar scroll-smooth w-full px-5">
                        ...
                        ?>
                        <button type="button" data-month="<?= $m_num ?>" onclick="toggleTableMonth(this, '<?= $m_num ?>')" class="flex-shrink-0 w-[38px] py-1 rounded text-[9px] font-bold uppercase tracking-wider transition-all table-month-btn text-center select-none border <?= $is_active ? '!bg-amber-500/20 !text-amber-400 shadow-sm !border-amber-500/50 active-month' : 'text-gray-500 border-transparent hover:text-amber-400 hover:bg-white/5' ?>">
                            <?= $m ?>
                        </button>
                        <?php endforeach; ?>
                    </div>
        ...
        <table class="w-full text-left border-collapse glass-table whitespace-nowrap" id="pullout-history-table">
            <thead>
                <tr style="border-bottom: 2px solid rgba(255, 255, 255, 0.2); background-color: rgba(255, 255, 255, 0.05);">
                    ...
                    <?php endif; ?>
                    <th class="px-5 py-3 font-bold text-gray-500 text-[10px] tracking-widest uppercase text-center border-b-2 border-white/20">ITR # / OS #</th>
                    ...
                    <th class="px-5 py-3 font-bold text-gray-500 text-[10px] tracking-widest uppercase text-center border-b-2 border-white/20">Image</th>
            ...
            <tbody id="pullout-tbody" class="text-sm">
                ...
                <?php else: ?>
                    ...
                    <tr class="hover:bg-white/5 transition-colors border-b border-white/5 last:border-0">
                        ...
                        <?php endif; ?>
                        <td class="px-5 py-3.5 font-bold text-amber-300 tracking-wide text-center" data-label="ITR # / OS #"><?= htmlspecialchars($p['item_no']) ?></td>
                        ...
                        <td class="px-5 py-3.5 text-center" data-label="Timestamp">
                            <?php if ($p['system_timestamp']): ?>
                                <span class="text-gray-400 text-[11px] font-medium whitespace-nowrap"><?= date('M d, Y h:i A', strtotime($p['system_timestamp'])) ?></span>
                            <?php else: ?>
