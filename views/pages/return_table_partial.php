...
<div class="glass-panel border border-white/5 shadow-xl overflow-hidden mt-6" id="history-section">
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="search" value="<?= htmlspecialchars($search) ?>" placeholder="Filter by Item or User..." 
                           class="w-full bg-slate-900/80 border border-white/10 rounded-lg pl-8 pr-4 py-1.5 h-8 text-xs text-white focus:outline-none focus:border-orange-500/50">
                </div>
            </div>
        ...
        <table class="w-full text-left border-collapse glass-table whitespace-nowrap">
            <thead>
                <tr>
                    ...
                    <?php endif; ?>
                    <th class="px-5 py-3 font-bold text-gray-500 text-[10px] tracking-widest uppercase">Returned Item</th>
                    ...
                    <th class="px-5 py-3 font-bold text-gray-500 text-[10px] tracking-widest uppercase">Reason</th>
                    <th class="px-5 py-3 font-bold text-blue-400/80 text-[10px] tracking-widest uppercase italic">Exchange</th>
                    <th class="px-5 py-3 font-bold text-blue-400/80 text-[10px] tracking-widest uppercase italic">Ex. Item #</th>
                    ...
                    <th class="px-5 py-3 font-bold text-gray-500 text-[10px] tracking-widest uppercase">User</th>
            ...
            <tbody id="history-tbody" class="text-sm">
                ...
                <?php else: ?>
                    ...
                    <tr class="hover:bg-white/5 transition-colors border-b border-white/5 last:border-0">
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex flex-col">
                                    ...
                                    <?php if (!empty($r['sname'])): ?>
                                        <span class="text-[9px] text-gray-500 font-bold uppercase tracking-tighter truncate max-w-[120px]"><?= htmlspecialchars($r['sname']) ?></span>
                                    <?php endif; ?>
                                </div>
                            </td>
                        <?php endif; ?>
                        ...
                        <td class="px-5 py-3.5 text-gray-300 font-bold text-center"><?= $row_qty ?></td>
                        <td class="px-5 py-3.5 text-center">
                        ...
                        <td class="px-5 py-3.5 text-gray-300 text-xs truncate max-w-[100px]" title="<?= htmlspecialchars($r['reason'] ?: '—') ?>">
                        ...
                        <td class="px-5 py-3.5 text-gray-300 text-xs"><?= htmlspecialchars($r['username']) ?></td>
                        <td class="px-5 py-3.5 text-gray-300 text-[11px] font-medium whitespace-nowrap"><?= date('M d, Y • h:i A', strtotime($r['created_at'])) ?></td>
                        <td class="px-5 py-3.5 text-center">
    ...
    <!-- Pagination -->
    <div class="px-5 py-3.5 border-t border-white/5 flex items-center justify-between bg-slate-800/10">
