                            ...
                            flatpickr(dateEl, {
                                ...
                                onReady: function(selectedDates, dateStr, instance) {
                                    ...
                                    btnContainer.innerHTML = `
                                        ...
                                        <button type="button" class="px-3 py-1.5 rounded bg-cyan-600 hover:bg-cyan-500 text-white text-[10px] font-bold uppercase transition-all fp-set">Today</button>
                                    `;
